...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"myTool.js":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  _createClass(myTool, null, [{
    ...
    value: function objectIndex(obj, index) {
      ...
      //如果不是对象或者字符串,直接返回
      if (Object.prototype.toString.call(obj) !== '[object Object]' || typeof index !== 'string') {
        return defaultValue;
      } else {
        index = index.split('.');
        var ans = obj;
        ...
        try {
          for (var _iterator = index[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            ...
            //判断是不是对象
            if (Object.prototype.toString.call(ans) === '[object Object]') {
    ...
    value: function clone(oldSource) {
      ...
      if (typeof oldSource === 'string' || typeof oldSource === 'number' || typeof oldSource === 'boolean' || _typeof(oldSource) === void 0 || typeof oldSource === null || typeof oldSource === 'function') {
        newSource = oldSource;
        return newSource;
      } else {
        //如果为对象
        if (Object.prototype.toString.call(oldSource) === '[object Object]') {} else {
          //如果为数组
...
},{}],"C:/Users/DELL/AppData/Local/Yarn/Data/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["C:/Users/DELL/AppData/Local/Yarn/Data/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","myTool.js"], null)
//# sourceMappingURL=/myTool.e067e47c.js.map